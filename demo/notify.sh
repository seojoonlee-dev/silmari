...
slack() { notify-send -a Slack -i "$HERE/icons/slack.png" -t 8000 "Minji Park · #hackathon" "did you send the intro draft yet?"; }
gmail() { notify-send -a Gmail -i "$HERE/icons/gmail.png" -t 8000 "Prof. Han" "Office hours moved to Friday 14:00, room 302"; }
case "${1:-slack}" in
  slack) slack ;;
  gmail) gmail ;;
  burst) slack; sleep 4; gmail; sleep 4; notify-send -a Slack -i "$HERE/icons/slack.png" -t 8000 "Jiho Kim · #hackathon" "demo is at 9, can someone bring the HDMI adapter" ;;
